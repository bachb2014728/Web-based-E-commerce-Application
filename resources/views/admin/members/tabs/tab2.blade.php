          ...
          <thead>
            <tr class="text-center">
              ...
              <th scope="col">Trạng thái :
                ...
                @else
                <span class="badge rounded-pill bg-danger ">Hủy đơn hàng</span>
                @endif
              </th>
            </tr>
          </thead>
          <tbody>
            @foreach ($items->order_detail->reverse() as $item)
            <tr class="text-center">
...
<div class="tab-foot">
  ...
  <p class="text-end m-2"><strong>Tổng số hóa đơn : <span class="badge bg-secondary">{{$users->hoadon->count()}}</span></strong> | Tổng tiền các hóa đơn : <strong id="price">{{$prices}}</strong></p> 
  @endif
</div>
